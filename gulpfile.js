...
gulp.src([bases.app + 'lib/css/sass/**/*.scss', '!' + bases.app + 'scss/libs/**/*.scss', '!' + bases.app + 'scss/states/_print.scss'])
.pipe(sassLint())
...
gulp.watch(bases.app + 'lib/css/sass/**/*.scss', ['styles']);
...
return gulp.src(bases.app + 'lib/css/sass/**/*.scss')
